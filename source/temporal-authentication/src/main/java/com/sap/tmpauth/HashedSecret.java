...
public class HashedSecret {
	 ...
	 * specified ttl. 
	 * 
	 * @param ttl time secret is valid
	 * @param temporalUnit see {@link java.time.temporal.TemporalUnit}
	...
	/**
	 * Validates some secret against my secret to check if they are equal.  If they are equal someSecret 
	 * is considered valid.
	 * 
	 * @param someSecret to compare to mySecret.  If equal someSecret is valid
	 * */
